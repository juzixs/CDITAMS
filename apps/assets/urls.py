...
urlpatterns = [
    ...
    path('scrap/', views.device_scrap_list, name='device_scrap_list'),
    path('<int:pk>/scrap/', views.device_scrap, name='device_scrap'),
    path('<int:pk>/recall/', views.device_recall, name='device_recall'),
    ...
    path('software/import-progress/', views.software_import_progress_api, name='software_import_progress_api'),
    path('software/download-template/', views.software_download_template, name='software_download_template'),
